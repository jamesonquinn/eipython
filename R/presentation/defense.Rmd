...
Say we can find an analytic function for the (approximate) MAP:  $f(\bm{\gamma}^*,\bm{x}_i)\approx \mathrm{MAP}(\bm{\lambda}_i|\bm{\gamma}^*,\bm{x}_i)$

Restrict to a lower-dimensional subfamily of $\mathcal{L}$
