...
\begin{tikzpicture}
  ...
  \node[const, below=7.2 of level, align=center]          (unobserved) {\blue{Vote totals}\\\blue{by race \& candidate}\\\blue{(unobserved)}};
  \node[const, below=9.2 of level, align=center]          (observed) {\purple{Vote totals by candidate}\\\purple{(observed)}};
