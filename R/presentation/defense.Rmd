...
* Means: $d$, 1 per model parameter
* Variances: $d$, 1 per model parameter
...
* Means: $d$, 1 per model parameter (so far - later, only globals)
* Variances: 0 guide parameters!
* Other? Well...
