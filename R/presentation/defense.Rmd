...
\begin{tikzpicture}
  ...
  \node[const, below=7.2 of level, align=center]          (unobserved) {\blue{Precinct vote totals}\\\blue{by race \& candidate}\\\blue{(unobserved)}};
  \node[const, below=9.2 of level, align=center]          (observed) {\purple{Precinct vote totals}\\\purple{by candidate (observed)}};
  ...
  \node[const, align=center, below=10.2 of King]      (Kingpro) {Uses constraints;\\Precinct-level variation};
