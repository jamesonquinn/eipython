...
\includegraphics[width=4in]{ECHSfits.pdf}
...
\begin{tikzpicture}
  ...
  \node[latent, below=4.3 of RJKT] (RJKTlatent) {$\green{\beta}$};
  \node[latent, diamond, below=5.7 of RJKT] (RJKTtheta) {$\green{\theta}$};
...
\begin{tikzpicture}
  ...
  \node[latent, below=4.3 of us] (uslatent) {$\green{\nu}$};
  \node[latent, diamond, below=5.7 of us] (usnu) {$\green{\pi}$};
...
\begin{tikzpicture}
  ...
  % Define nodes
  \node[const]                                          (hats) {$\orange{\bm{\gamma}^*}$};
  \node[det, below=1 of hats,  align=center, xshift=3.5cm]            (yhat) {$\green{\bm{\lambda}}^{\blue{*}}_{\blue{u}}$};
  \node[latent, diamond, below=2 of hats, xshift=.7cm]            (sighat) {$\orange{\sigma_{\nu}^*}$};
  
  \node[latent, diamond, aspect=2.05, below=3 of hats]            (Iparams) {$\mathcal{I}_p(\bm{\gamma}^*)$};
  
  \node[latent, diamond, aspect=2.05, below=4.5 of hats]            (Iparams2) {$\mathcal{G}_p(\bm{\gamma}^*)$};
  \factor[left=of Iparams2] {paramdist} {left:$\mathcal{N}$} {} {};
  \node[latent, below=of paramdist]            (params) {$\orange{\bm{\gamma}}$};
  

  
  \node[latent, diamond, aspect=3,  below=3 of hats,  align=center, xshift=3.5cm]  (Ifull) {$\mathcal{I}_p^{-1}(\bm{\gamma}^*,\bm{\lambda}^*_{u})$};
  \factor[right=of Ifull] {fulldist} {right:$\mathcal{N}$} {} {};
  \factor[below=2.75 of fulldist] {condfulldist} {right:$\mathcal{N}|\bm{\gamma}$} {} {};
  \node[latent, below=of condfulldist]            (W) {$\green{\bm{\lambda}}_{\blue{u}}$};
  ...
  \edge {Iparams,Ifull} {Iparams2} ;       %   \|
  \edge[-] {Iparams2} {paramdist} ;        % - 
...
<!--   % Define nodes -->
<!--   \node[const]                                          (hats) {$\bm{\gamma}^*$}; -->
<!--   \node[det, right=2.5 of hats, yshift=-1.2cm]            (yhat) {$\bm{W}^*_{u}$}; -->
<!--   \node[det, right=1.5 of hats, yshift=-2cm]            (nuhat) {$\bm{\nu}^*_{u}$}; -->
<!--   \node[latent,fill=gray!25, diamond, right=.3 of hats, yshift=-2.6cm]            (sighat) {$\sigma_{\nu}^*$}; -->

<!--   \node[latent, diamond, aspect=2.5, below=3.4 of hats]            (Iparams) {$\mathcal{I}^{-1}(\bm{\gamma}^*)$}; -->
<!--   \factor[left=of Iparams, xshift = -1cm] {paramdist} {left:$\mathcal{N}$} {} {}; -->
<!--   \node[latent, below=.8 of Iparams]            (params) {$\bm{\gamma}$}; -->



<!--   \node[latent, diamond, aspect=2.5, right=.33 of Iparams]  (Ifull) {$\mathcal{I}^{-1}(\bm{\gamma}^*,\bm{W}^*_{u})$}; -->
<!--   \factor[right=.8 of Ifull] {fulldist} {right:$\mathcal{N}$} {} {}; -->
<!--   \factor[below=1.5 of fulldist] {condfulldist} {right:$\mathcal{N}|\bm{\gamma}$} {} {}; -->
<!--   \node[latent, below=2 of Ifull]            (W) {$(W_u,\bm{\nu}_{u})$}; -->
<!--   \node[const, below=0.2 of W,xshift=-0.2cm]            (uhide) {}; -->
<!--   \node[const, below=0.2 of W,xshift=3.6cm]            (uhide2) {}; -->

<!--   % Connect the nodes -->
<!--   \edge[] {hats,nuhat,sighat} {Iparams} ;        %  |/ -->
<!--   \draw [->] (yhat) to [out=270, in=30] (Iparams) ; -->
<!--   \edge[] {yhat} {nuhat} ;                %   ⟋ -->
<!--   \edge[] {nuhat} {sighat} ;                %   ⟋ -->
<!--   \edge[-] {hats} {paramdist} ;           % / -->
<!--   \edge {hats} {nuhat,yhat} ;             %   ⟍ -->
<!--   \edge {hats,yhat,nuhat,sighat} {Ifull} ;       %   \| -->
<!--   \edge[-] {Iparams} {paramdist} ;        % -  -->
<!--   \edge {paramdist} {params} ;            % \ -->
<!--   \edge[-] {Ifull} {fulldist}  ;  -->
<!--   \edge[-] {fulldist} {condfulldist}  ;  -->
<!--   \edge[-] {params} {condfulldist};  -->
<!--   \edge[-] {yhat,nuhat} {fulldist} ;  -->
<!--   \edge {condfulldist} {W} ;  -->

<!--   % Plates -->
<!--   \plate {U} {(Ifull)(fulldist)(W)(uhide)(uhide2)(yhat)(nuhat)} {$U$} ; -->
<!-- \end{tikzpicture}} -->
