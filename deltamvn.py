...
class DeltaMVN(TorchDistribution):
    r"""
    For density purposes: Creates a multivariate normal (also called Gaussian) distribution
    parameterized by a mean vector and a covariance matrix.

    For sampling purposes: Deterministically sample the mode.
    ...
    def __init__(self, loc, covariance_matrix=None, precision_matrix=None, scale_tril=None, validate_args=None):
        ...
        super(DeltaMVN, self).__init__(batch_shape, event_shape, validate_args=validate_args)
    ...
    def expand(self, batch_shape, _instance=None):
        ...
        super(DeltaMVN, new).__init__(batch_shape,
                                                self.event_shape,
                                                validate_args=False)
