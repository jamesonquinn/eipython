...
from utilities.ramanujan import *
...
class StudentT_ram(TorchDistribution):
    r"""
    ...
    def log_prob(self, value):
        ...
        Z = (self.scale.log() +
             ...
             lgamma_difble(0.5 * self.df) -
             lgamma_difble(0.5 * (self.df + 1.)))
        return -0.5 * (self.df + 1.) * torch.log1p(y**2. / self.df) - Z

    def entropy(self):
        lbeta = lgamma_difble(0.5 * self.df) + math.lgamma(0.5) - lgamma_difble(0.5 * (self.df + 1))
