...
class CMult(Distribution):
    ...
    def __init__(self, total_count=1, probs=None, logits=None, validate_args=None):
        ...
        super(CMult, self).__init__(batch_shape, event_shape, validate_args=validate_args)
    ...
    def expand(self, batch_shape, _instance=None):
        ...
        super(CMult, new).__init__(batch_shape, self.event_shape, validate_args=False)
